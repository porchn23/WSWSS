...
const translations = {
  en: {
    ...
    slidePrimerResult: 'Helps the cream sit close to skin and blur the look of pores', slidePrimerIngredients: 'Cyclopentasiloxane · Phenyl Trimethicone · Dimethicone Crosspolymer', slidePrimerCopy: 'Pores look less visible, skin looks smoother, and makeup applies more easily.',
    slideWhiteningResult: 'Cares for dull-looking skin to support a brighter, more even-looking tone', slideWhiteningIngredients: 'Glutathione · Niacinamide · Tranexamic Acid · Ascorbyl Glucoside', slideWhiteningCopy: 'Skin looks fresher and more even with continued use.',
    ...
    useStepOne: 'Dispense', useStepTwo: 'Pat', useStepThree: 'Blend', useStepOneCopy: 'Use a pea-sized amount and dot it across 5 points on the face. The concentrated formula helps one tube last longer.', useStepTwoCopy: 'Gently pat across the face and neck to help the cream adhere.', useStepThreeCopy: 'Blend gently for a smooth, natural-looking finish.',
  ...
  ko: {
    ...
    slidePrimerResult: '크림이 피부에 밀착되도록 돕고 모공을 자연스럽게 블러', slidePrimerIngredients: 'Cyclopentasiloxane · Phenyl Trimethicone · Dimethicone Crosspolymer', slidePrimerCopy: '모공이 덜 도드라져 보이고 피부결은 매끈하게, 메이크업은 더 쉽게.',
    slideWhiteningResult: '칙칙해 보이는 피부를 케어해 맑고 균일한 피부 톤을 도움', slideWhiteningIngredients: 'Glutathione · Niacinamide · Tranexamic Acid · Ascorbyl Glucoside', slideWhiteningCopy: '꾸준히 사용할수록 피부가 더 생기 있어 보이고 톤이 고르게.',
    ...
    useStepOne: '덜기', useStepTwo: '두드리기', useStepThree: '펴 바르기', useStepOneCopy: '완두콩 한 알 정도의 양을 얼굴 5곳에 나누어 찍어 주세요. 고농축 크림이라 한 튜브로 오래 사용할 수 있습니다.', useStepTwoCopy: '얼굴과 목에 부드럽게 두드려 밀착시켜 줍니다.', useStepThreeCopy: '자연스럽고 매끈한 피부 표현을 위해 부드럽게 펴 바릅니다.',
